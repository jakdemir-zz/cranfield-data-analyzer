...
public class SearchFiles {
	...
	public static void main(String[] args) throws Exception {
		...
		while (true) {
			...
			doPagingSearch(in, out, searcher, query, hitsPerPage, raw,
					queries == null && queryString == null, q_id);
	 ...
	 * 
	 */
	public static void doPagingSearch(BufferedReader in, String out_f,
		...
		while (true) {
			...
			for (int i = start; i < end; i++) {
				...
				if (path != null) {
					...
					out.write(q_id + " 0  " + path + "  " + i + " " + score
							+ "  CSI550\n");
					System.out.println(q_id + " 0  " + path + "  " + i + " "
							+ score + "  CSI550");
				} else {
